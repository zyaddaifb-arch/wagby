      ...
      <div className={`${styles.formPanel} animate-fade-in-up`}>
        ...
        <div className={styles.formWrapper}>
          <div className={styles.formHeader}>
            <h1 className={styles.formTitle}>مرحباً بعودتك! 👋</h1>
            <p className={styles.formSubtitle}>سجّل دخولك لمتابعة طلابك وإبداعاتهم</p>
          </div>
              ...
              <form className={styles.formContainer} onSubmit={handleSubmit}>
                {error && (
                  <div className={styles.errorAlert}>
                    ⚠️ {error === 'Invalid login credentials' ? 'بيانات الدخول غير صحيحة (Invalid password). تحقق من الإيميل وكلمة المرور.' : error}
                  </div>
                )}
