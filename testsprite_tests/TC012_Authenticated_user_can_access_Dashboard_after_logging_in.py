...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'ابدأ كمدرس' (Start as teacher) button to navigate to the login page.
        ...
        # -> Fill the email and password fields with test credentials and click the 'تسجيل الدخول' button.
        frame = context.pages[-1]
        # Input text
